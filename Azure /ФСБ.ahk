...
Gui Add, Edit, vProbivGosId x431 y630 w90 h22, %ProbivGosId%
...
Gui Add, Text, x330 y630 w125 h25 +0x200 , Пробив id
...
F3::
    toggle := !toggle
    if (toggle) {
	addChatMessageEx(0xFFFFFF, "{58e11b}[Диспетчер] {ffffff} Оповещение включено.")
	Sleep 5000
        SetTimer, SpamMessages, 100
    } else {
	addChatMessageEx(0xFFFFFF, "{58e11b}[Диспетчер] {ffffff} Оповещение выключено.")
	Sleep 5000
        SetTimer, SpamMessages, Off
    }
return

SpamMessages:
    sendChat("/d [УФСБ] На связи Физик. На территории Нижегородской области действует КТО в связи с чем патруль от трёх человек.")
    Sleep 20001
    sendChat("/d [УФСБ] Для минизирования похищений не реагируйте на странные вызовы граждан, старайтесь находиться в городе.")
    Sleep 600000
return

:?:!дп::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/] %Dolzhnost% с личным позывным - %Teg%, на связь{!} {left 1}
Return
...
:?:!увд::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/УМВД] %Dolzhnost% с личным позывным - %Teg%, на связь{!} {left 1}
Return

:?:!увдд::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/УМВД] %Dolzhnost% с личным позывным - %Teg% на связи, слушаю Вас... {left 1}
Return

:?:!вчч::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/ВЧ] %Dolzhnost% с личным позывным - %Teg% на связи, слушаю Вас... {left 1}
Return

:?:!вч::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/ВЧ] %Dolzhnost% с личным позывным - %Teg%, на связь{!} {left 1}
Return

:?:!пр::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/ПР] %Dolzhnost% с личным позывным - %Teg%, на связь{!} {left 1}
Return

:?:!прр::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/ПР] %Dolzhnost% с личным позывным - %Teg% на связи, слушаю Вас... {left 1}
Return


:?:!ес::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/ЕСС] %Dolzhnost% с личным позывным - %Teg%, на связь{!} {left 1}
Return

:?:!есс::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/ЕСС] %Dolzhnost% с личным позывным - %Teg% на связи, слушаю Вас... {left 1}
Return

:?:!фс::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/УФСИН] %Dolzhnost% с личным позывным - %Teg%, на связь{!} {left 1}
Return

:?:!фсс::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/УФСИН] %Dolzhnost% с личным позывным - %Teg% на связи, слушаю Вас... {left 1}
Return

:?:!гаи::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/ГАИ] %Dolzhnost% с личным позывным - %Teg%, на связь{!} {left 1}
Return

:?:!гаии::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/ГАИ] %Dolzhnost% с личным позывным - %Teg% на связи, слушаю Вас... {left 1}
Return
...
:?:!гаип::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/ГАИ] %Dolzhnost% с личным позывным - %Teg%. Стройте состав на парковке ГАИ, готовность -  минут.{left 7}
Return

:?:!увдп::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/УМВД] %Dolzhnost% с личным позывным - %Teg%. Стройте состав на парковке УМВД, готовность -  минут.{left 7}
Return

:?:!фсп::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/УФСИН] %Dolzhnost% с личным позывным - %Teg%. Стройте состав на парковке УФСИН, готовность -  минут.{left 7}
Return

:?:!вчп::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/ВЧ] %Dolzhnost% с личным позывным - %Teg%. Стройте состав на парковке ВЧ, готовность -  минут.{left 7}
Return

:?:!есп::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/ЕСС] %Dolzhnost% с личным позывным - %Teg%. Стройте состав на парковке ЕСС, готовность -  минут.{left 7}
Return

:?:!вгп::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/УМВД/ГАИ/ВЧ] %Dolzhnost% с личным позывным - %Teg%. Стройте состав на парковке УФСБ, готовность -  минут.{left 7}
Return
...
CreateWindow1() {
    ...
    Gui, 1:Add, Text,,       Ctrl 3             	Протокол (ИВС)
    Gui, 1:Add, Text,,       Ctrl 4             	/deject
    Gui, 1:Add, Text,,       Ctrl 5             	Эвакуация
    Gui, 1:Add, Text,,       Ctrl 6             	Сдача на штрафку
    Gui, 1:Add, Text,,       Ctrl 0             	Передача в ИВС
    Gui, 1:Add, Text,,       F9             	/police
    ...
    Gui, 1:Add, Text,,       (!аудиовидео)    Досмотр
    Gui, 1:Add, Text,,       (!док)             	Ксива
    Gui, 1:Add, Text,,       LAlt B             	Перезагрузка
    Gui, 1:Add, Text,,             	             	             	    
    Gui, 1:Add, Text,,       LAlt C             	Окно /d
    Gui, 1:Add, Text,,       LAlt V             	Окно ПП/СВУ
...
CreateWindow2() {
    ...
    Gui, 2:Add, Text,,       (!фсбб)             	На связи ГАИ
    Gui, 2:Add, Text,,       (!фсб)             	На связь ГАИ
