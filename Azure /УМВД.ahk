...
Gui Add, Text, x330 y550 w125 h25 +0x200 , Протокол (АПН)
...
KeySix:
sendChat("Здравия желаю, я - " . Dolzhnost . ", в специальном звании " . Rank . ", мой позывной " . Teg . ".")
return
...
kvgp:
    ...
    if ((CurrentTime >= 1500 && CurrentTime < 1505) || (CurrentTime >= 1900 && CurrentTime < 1915)) {
        ...
        addChatMessageEx(-1, "{58e11b}[Диспетчер]{FFFFFF} Нажмите {58e11b}3{FFFFFF}, если ВГП на Автошколе.")
        ...
        addChatMessageEx(-1, "{58e11b}[Диспетчер]{FFFFFF} Нажмите {58e11b}3{FFFFFF}, если заняли Автошколу.")
        addChatMessageEx(-1, "{58e11b}[Диспетчер]{FFFFFF} Нажмите {58e11b}4{FFFFFF}, для отмены.")
...
Handle7:
    ...
    if (A_ThisLabel = "Handle1")
        sendChat("/d [" . TegText . "] Докладывает " . Dolzhnost . ". Крушение ВГП произошло на точке Лыткарино.")
    else if (A_ThisLabel = "Handle2")
        sendChat("/d [" . TegText . "] Докладывает " . Dolzhnost . ". Крушение ВГП произошло на точке Завод.")
    else if (A_ThisLabel = "Handle3")
        sendChat("/d [" . TegText . "] Докладывает " . Dolzhnost . ". Крушение ВГП произошло на точке Автошкола.")
    else if (A_ThisLabel = "Handle5")
        sendChat("/d [" . TegText . "] Докладывает " . Dolzhnost . ". Занял точку возможного крушения - Лыткарино.")
    else if (A_ThisLabel = "Handle6")
        sendChat("/d [" . TegText . "] Докладывает " . Dolzhnost . ". Занял точку возможного крушения - Завод.")
    else if (A_ThisLabel = "Handle7")
        sendChat("/d [" . TegText . "] Докладывает " . Dolzhnost . ". Занял точку возможного крушения - Автошкола.")
...
KeyProtokol:
SendChat("/do Планшет, бланк протокола об АПН и ручка находятся в подсумке.")
Sleep 1500
SendChat("/me правой рукой берёт ручку, затем достаёт планшет, на него кладёт бланк, начинает заполнять")
Sleep 1500
SendChat("/me вносит в бланк протокола об АПН такую информацию, как: ФИО инспектора и гражданина; серию и номер документа удостоверяющего личность гражданина; место, время и обстоятельства совершения нарушения; ставит свою подпись")
Sleep 1000
sendChat("/frac " playerID)
sleep 250
SendInput, {1}{1}
...
SendInput, {Enter}
sleep 1500
sendChat("Ознакамливаться будете?")
Return
...
:?:!кор5::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [ГАИ] Ввожу корректировки в ЛД № по статье 5 ПК.{left 16}
Return

:?:!кор7::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [ГАИ] Ввожу корректировки в ЛД № по статье 7 ПК.{left 16}
Return
...
Sleep 1000
sendChat("/do Дежурный ушёл с задержанным, составил протокол о задержании.")
Sleep 1000
sendChat("/frac " playerID)
sleep 450
SendInput, {1}{1}
...
Sleep 500
sendChat("/do В руке человека жетон УМВД по НО с личным номером СБ-" . Mask . ".")
Sleep 500
...
:?:!дп::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%] %Rank% с личным позывным - %Teg%, на связь{!} {left 1}
Return
...
:?:!дпп::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/] %Rank% с личным позывным - %Teg% на связи, слушаю Вас...{left 1}
Return

:?:!фсбб::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/УФСБ] %Rank% с личным позывным - %Teg% на связи, слушаю Вас... {left 1}
Return

:?:!фсб::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/УФСБ] %Rank% с личным позывным - %Teg%, на связь{!} {left 1}
Return

:?:!увд::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/УМВД] %Rank% с личным позывным - %Teg%, на связь{!} {left 1}
Return

:?:!увдд::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/УМВД] %Rank% с личным позывным - %Teg% на связи, слушаю Вас... {left 1}
Return

:?:!вчч::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/ВЧ] %Rank% с личным позывным - %Teg% на связи, слушаю Вас... {left 1}
Return

:?:!вч::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/ВЧ] %Rank% с личным позывным - %Teg%, на связь{!} {left 1}
Return

:?:!пр::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/ПР] %Rank% с личным позывным - %Teg%, на связь{!} {left 1}
Return

:?:!прр::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/ПР] %Rank% с личным позывным - %Teg% на связи, слушаю Вас... {left 1}
Return


:?:!ес::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/ЕСС] %Rank% с личным позывным - %Teg%, на связь{!} {left 1}
Return


:?:!есс::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/ЕСС] %Rank% с личным позывным - %Teg% на связи, слушаю Вас... {left 1}
Return

:?:!фс::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/УФСИН] %Rank% с личным позывным - %Teg%, на связь{!} {left 1}
Return

:?:!фсс::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/УФСИН] %Rank% с личным позывным - %Teg% на связи, слушаю Вас... {left 1}
Return

:?:!гаи::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/ГАИ] %Rank% с личным позывным - %Teg%, на связь{!} {left 1}
Return

:?:!гаии::
SendMessage, 0x50,, 0x4190419,, A
SendInput /d [%TegText%/ГАИ] %Rank% с личным позывным - %Teg% на связи, слушаю Вас... {left 1}
Return
...
CreateWindow1() {
    ...
    Gui, 1:Add, Text,,       Alt 1          	Ввести в базу данных ID
    Gui, 1:Add, Text,,       Alt 2            	/chase
    Gui, 1:Add, Text,,       Alt 3              	Миранда
    Gui, 1:Add, Text,,       Alt 4              	Преды
    Gui, 1:Add, Text,,       Alt 5           	Вести за собой
    Gui, 1:Add, Text,,       Alt 0           	Пробить розыск
    Gui, 1:Add, Text,,       Alt E             	/id - рег
    Gui, 1:Add, Text,,       LAlt H             	Дом
    Gui, 1:Add, Text,,       RAlt H             	Особняк
    Gui, 1:Add, Text,,       Alt L             	Доклад о КВГП
    Gui, 1:Add, Text,,       Ctrl 1             	Представиться
    Gui, 1:Add, Text,,       Ctrl 2             	/cuff
    Gui, 1:Add, Text,,       Ctrl 3             	Протокол (АПН)
    Gui, 1:Add, Text,,       Ctrl 4             	/deject
    Gui, 1:Add, Text,,       Ctrl 0             	Передача в ИВС
    Gui, 1:Add, Text,,       F10             	Розыск (выдать)
    Gui, 1:Add, Text,,       F11             	Посадить в авто
    Gui, 1:Add, Text,,       F12             	/sos
    Gui, 1:Add, Text,,       (!кор5 / !кор7)  	ПК ст.5/7
    Gui, 1:Add, Text,,       (!док)             	Ксива
    Gui, 1:Add, Text,,       LAlt B             	Перезагрузка
    Gui, 1:Add, Text,,             	             	             	    
    Gui, 1:Add, Text,,       LAlt C             	Второе окно
    Gui, 1:Add, Text,,       LAlt V             	Окно ПП
...
CreateWindow4() {
    ...
    Gui, 4:Add, Text,,             	             	             	    
    Gui, 4:Add, Text,,       LAlt X             		Первое окно
    Gui, 4:Add, Text,,       LAlt C             		Второе окно
    Gui, 4:Add, Text,,             	             	             	    
